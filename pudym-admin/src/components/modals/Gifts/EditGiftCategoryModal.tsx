...
interface EditGiftCategoryModalProps {
    isOpen: boolean;
...
const EditGiftCategoryModal = ({
    isOpen,
    category,
    onClose,
    onSuccess,
}: EditGiftCategoryModalProps) => {
    ...
    const handleSubmit = async (
        ...
        if (
            editGiftCategory.fulfilled.match(result) &&
            ...
            <div className="w-full max-w-[500px] rounded-xl bg-white shadow-xl">
                ...
                <div className="flex items-center justify-between border-b border-[#EAECF0] px-6 py-5">
                    ...
                    <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg text-[#667085] hover:bg-gray-100 disabled:opacity-50"
                    >
                        <X size={18} />
                    </button>
